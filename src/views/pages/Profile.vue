	...
	<vue-scroll class="page-profile" id="affix-container">
		<div class="card-base card-shadow--medium identity" id="boundary">
			...
			<div class="username">
				...
				<div class="avatar-small"><img src="@/assets/images/profile.png" alt="avatar"></div>
				<span>{{username}}</span>
				<div class="colors-box">
					<div v-for="i in 5" :key="i" :class="{'color':true, 'active':colorActive}" :style="{'background':color}"></div>
				</div>
			</div>
			<div class="avatar"><img src="@/assets/images/profile.png" alt="avatar"></div>
			<img src="@/assets/images/Foto-2.jpg" id="color-thief" class="color-thief" alt="profile cover">
		</div>
