<template>
	<el-dialog :show-close="true" center :custom-class="'user-dialog'" :visible="dialogvisible" @close="$emit('update:dialogvisible', false)">
		...
		<div class="form-box">
			<el-input placeholder="Nombre" ></el-input>
			<el-input placeholder="Teléfono" ></el-input>
			<el-input placeholder="Dirección" ></el-input>
			<el-input placeholder="Ciudad" ></el-input>
			<el-input placeholder="País" ></el-input>
...
export default {
	...
	methods: {
		submit(){
			setContacts(this.form).then(({data}) => {
				console.log(data)
